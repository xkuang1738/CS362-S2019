...
Description: HW3 cardtest4.c, testing dominion code cards. This file unit tests the code of salvager card.  The player's hand and deck are set before each test case and is compared to the known correct result.  
*/
#include "dominion.h"
